    ...
    <ChakraProvider>
     ...
     <Box m={20} bg="white" borderRadius={20} color="black" p={10} border="2px" borderColor="gray.100">
        ...
        <Flex justifyContent="center" mx="auto" flexDirection="row" flexWrap="wrap">
          <Box borderRadius={20} bg="pink.100" p={5} mr={5} mb={5} _hover={{ transform: "scale(1.1)" }}>
          ...
          <Box borderRadius={20} bg="blue.100" p={5} mr={5} mb={5} _hover={{ transform: "scale(1.1)" }}>
              <VStack alignItems="start">
          ...
          <Box borderRadius={20} bg="purple.100" p={5} mb={5} _hover={{ transform: "scale(1.1)" }}>
              <VStack alignItems="start">
